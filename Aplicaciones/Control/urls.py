...
urlpatterns=[
    ...
    path('generar_pdf_reporte/', views.generar_pdf_reporte, name='generar_pdf_reporte'),
    path('generar_pdf_reporte/<int:reporte_id>/', views.generar_pdf_reporte, name='generar_pdf_reporte'),
